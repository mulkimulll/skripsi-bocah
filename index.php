            ...
            <div class="card" style=" background: #ddd">
                <div class="card-body">
                    <?php if($_SESSION['USER']){?>
                        ...
                        <center>
                            <?php if($_SESSION['USER']['level'] == 'admin'){?>
                                <a href="admin/index.php" class="btn btn-dark mb-2 btn-block">Dashboard</a>
                            <?php }else{?>
                                <a href="blog.php" class="btn btn-ungu mb-2 btn-block text-white">Booking Sekarang !</a>
                            <?php }?>
                    ...
                    <!-- <form method="post" action="koneksi/proses.php?id=login">
                        ...
                        <center><button class="btn btn-dark">Login</button>
                        
                        <a class="btn btn-ungu text-white" data-toggle="modal" data-target="#modelId">
                            Daftar
                         </a></center>
                    </form> -->
                    <?php }?>
