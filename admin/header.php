    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #333;">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item <?php if($title_web == 'Daftar Pelayanan'){ echo 'active';}?>
                <?php if($title_web == 'tambah Kostum'){ echo 'active';}?>
                <?php if($title_web == 'Edit kostum'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/mobil/mobil.php">Daftar Pelayanan</a>
                </li>
                ...
                <li class="nav-item <?php if($title_web == 'Peminjaman'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/peminjaman/peminjaman.php">No Booking</a>
